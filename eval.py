...
from gnt.data_loaders.create_training_dataset import create_training_dataset, create_eval_dataset
import imageio
...
def log_view(
    ...
    print("Image coarse shape: ", rgb_coarse.shape, "\n")
    ...
    print(filename)
    img = (rgb_coarse * 255).astype(np.uint8)
...
if __name__ == "__main__":
    ...
    if args.distributed:
        torch.cuda.set_device('cuda:{}'.format(args.local_rank))
